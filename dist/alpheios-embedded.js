...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "incr-3.4.x-update-build", buildNumber: "20220429317", buildName: "incr-3.4.x-update-build.20220429317", name: packageDescription },
