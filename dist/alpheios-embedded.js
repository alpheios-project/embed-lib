...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "incr-3.4.x", buildNumber: "20220504216", buildName: "incr-3.4.x.20220504216", name: packageDescription },
