...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.AppController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "dev-ui-controller-refactoring", buildNumber: "20200625546", buildName: "dev-ui-controller-refactoring.20200625546", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
