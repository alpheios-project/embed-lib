...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "update-incr-3.3-incr-3.4", buildNumber: "20211126398", buildName: "update-incr-3.3-incr-3.4.20211126398", name: packageDescription },
