...
module.exports = JSON.parse('{"name":"alpheios-embedded","version":"3.4.2-incr-3.4.x.20220429024","description":"Alpheios Embedded Library","main":"dist/alpheios-embedded.js","directories":{"doc":"doc"},"scripts":{"set-node-build-deps":"npx install-peerdeps@v2.0.2 alpheios-node-build --dev --only-peers","test":"jest","build":"npm run build-dev && npm run build-prod","build-prod":"npm run lint && node --experimental-modules ./node_modules/alpheios-node-build/dist/build.mjs -m webpack -M production -p app -c config.mjs","build-dev":"npm run lint && node --experimental-modules ./node_modules/alpheios-node-build/dist/build.mjs -m webpack -M development -p app -c config.mjs","auth0-env-update":"node --experimental-modules ./node_modules/alpheios-node-build/dist/files.mjs replace --s=../protected-config/auth0/prod --t=dist/auth0 --f=env-embed.js","auth0-env-dev-update":"node --experimental-modules ./node_modules/alpheios-node-build/dist/files.mjs replace --s=../protected-config/auth0/dev --t=dist/auth0 --f=env-embed.js","lint":"eslint --fix src/**/*.js","update-dependencies":"node --experimental-modules ./node_modules/alpheios-node-build/dist/files.mjs replace --s=./node_modules/alpheios-core/packages/components/dist/ --t=dist/lib && node --experimental-modules ./node_modules/alpheios-node-build/dist/files.mjs replace --s=./node_modules/alpheios-core/packages/components/dist/style --t=dist/style","build-experimental":"node --experimental-modules ./node_modules/alpheios-node-build/dist/build.mjs -m webpack -M development -p app -c config.mjs","dev":"npm run build-experimental && http-server -c-1 -p 8888 & onchange src -- npm run build-experimental","conventional-commit":"npx git-cz","version-set-major":"npm version major","version-set-minor":"npm version minor","version-set-patch":"npm version patch","tagged-commit":"node --experimental-modules --experimental-json-modules ./tagged-commit.mjs","github-build":"node --experimental-modules --experimental-json-modules ./github-build.mjs"},"repository":{"type":"git","url":"git+https://github.com/alpheios-project/wordsvc.git"},"author":"The Alpheios Project, Ltd.","license":"ISC","bugs":{"url":"https://github.com/alpheios-project/wordsvc/issues"},"homepage":"https://github.com/alpheios-project/wordsvc#readme","devDependencies":{"@actions/core":"^1.7.0","@babel/core":"^7.17.10","@babel/plugin-proposal-object-rest-spread":"^7.17.3","@babel/plugin-transform-modules-commonjs":"^7.17.9","@babel/plugin-transform-runtime":"^7.17.10","@babel/preset-env":"^7.17.10","@babel/register":"^7.17.7","@babel/runtime":"^7.17.9","@vue/compiler-sfc":"^3.2.33","alpheios-core":"https://github.com/alpheios-project/alpheios-core.git#incr-3.4.x","alpheios-node-build":"https://github.com/alpheios-project/node-build#v5","archiver":"^5.3.1","babel-eslint":"^10.1.0","babel-loader":"^8.2.5","babel-plugin-dynamic-import-node":"^2.3.3","babel-plugin-module-resolver":"^4.1.0","chalk":"^5.0.1","command-line-args":"^5.2.1","copy-webpack-plugin":"^6.4.1","coveralls":"^3.1.1","css-loader":"^6.7.1","css-minimizer-webpack-plugin":"^3.4.1","cz-conventional-changelog":"^3.3.0","eslint":"^7.32.0","eslint-config-standard":"^16.0.3","eslint-plugin-import":"^2.26.0","eslint-plugin-node":"^11.1.0","eslint-plugin-promise":"^4.3.1","eslint-plugin-standard":"^4.1.0","eslint-plugin-vue":"^7.20.0","fibers":"^5.0.1","fs-extra":"^10.1.0","git-branch":"^2.0.1","http-server":"^0.12.3","imagemin":"^8.0.1","imagemin-jpegtran":"^7.0.0","imagemin-optipng":"^8.0.0","imagemin-svgo":"^10.0.1","inspectpack":"^4.7.1","interactjs":"^1.10.11","jest":"^26.6.3","jest-fetch-mock":"^3.0.3","mini-css-extract-plugin":"^2.6.0","node-sass":"^7.0.1","onchange":"^7.1.0","path":"^0.12.7","postcss":"^8.4.13","postcss-import":"^14.1.0","postcss-loader":"^6.2.1","postcss-safe-important":"^1.2.1","postcss-scss":"^4.0.4","raw-loader":"^4.0.2","sass":"^1.51.0","sass-loader":"^12.6.0","shx":"^0.3.4","source-map-loader":"^3.0.1","style-loader":"^2.0.0","url-loader":"^4.1.1","vue-loader":"^15.9.8","vue-style-loader":"^4.1.3","vue-svg-loader":"^0.16.0","vue-template-compiler":"^2.6.14","vue-template-loader":"^1.1.0","webpack":"^5.72.0","webpack-bundle-analyzer":"^4.5.0","webpack-cleanup-plugin":"^0.5.1","webpack-dev-server":"^3.11.3","webpack-merge":"^5.8.0"},"engines":{"node":">= 14.1.0","npm":">= 6.13.0"},"jest":{"verbose":true,"transform":{"^.+\\\\.jsx?$":"babel-jest"},"transformIgnorePatterns":["node_modules/alpheios-core/packages/components/"]},"eslintConfig":{"env":{"browser":true,"node":true},"parser":"babel-eslint","parserOptions":{"sourceType":"module","ecmaVersion":2019,"allowImportExportEverywhere":true}},"eslintIgnore":["**/dist"],"config":{"commitizen":{"path":"./node_modules/cz-conventional-changelog"}}}');
...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "incr-3.4.x-update-node-build", buildNumber: "20220504507", buildName: "incr-3.4.x-update-node-build.20220504507", name: packageDescription },
