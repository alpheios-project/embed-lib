...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.UIController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "i140-core-app-wide-config", buildNumber: "20200410538", buildName: "i140-core-app-wide-config.20200410538", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
