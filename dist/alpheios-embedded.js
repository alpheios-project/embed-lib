...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "incr-3.4.x-update-build", buildNumber: "20220428672", buildName: "incr-3.4.x-update-build.20220428672", name: packageDescription },
...
/*!   export @vue/compiler-sfc [provided] [no usage info] [missing usage info prevents renaming] */
