...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.UIController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "i258-treebank-retry-count", buildNumber: "20200514458", buildName: "i258-treebank-retry-count.20200514458", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
