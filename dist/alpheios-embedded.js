...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.UIController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "production", buildNumber: "20200609574", buildName: "20200609574", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
