...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.UIController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "qa", buildNumber: "20200618499", buildName: "qa.20200618499", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
