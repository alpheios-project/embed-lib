          ...
          this.auth0Lock = new Auth0Lock(this.env.CLIENT_ID, this.env.DOMAIN, {
            ...
            auth: {
              ...
              params: {
                ...
                login_hint: 'youremail@example.com'
              },
              login_hint: 'youremail@example.com',
