...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "incr-3.4.x", buildNumber: "20211126130", buildName: "incr-3.4.x.20211126130", name: packageDescription },
