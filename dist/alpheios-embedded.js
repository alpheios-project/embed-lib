...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "qa", buildNumber: "20200814314", buildName: "qa.20200814314", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
