...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "githubactions", buildNumber: "20200814408", buildName: "githubactions.20200814408", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
